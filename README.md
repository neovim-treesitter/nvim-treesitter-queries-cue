# nvim-treesitter-queries-cue

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-cue/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-cue/actions/workflows/validate.yml)

Neovim tree-sitter queries for **cue**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-cue",
...
- [ ] Changes are scoped to `cue` — do not include files for other languages
